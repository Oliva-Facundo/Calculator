...
function App() {
  ...
  return (
    <>
      ...
      >
        <main className={`max-w-[32rem] max-h-[45rem] w-[32rem] max-sm:min-w-[20rem] max-sm:p-4`}>
          ...
          <div
            className={`h-[8rem] rounded-lg bg-bgScreen mb-6 flex items-center justify-end pr-8 text-6xl overflow-x-auto whitespace-nowrap max-w-full `}
          >
            {nums}
          </div>
          <div className="grid grid-cols-4 gap-6 p-8 rounded-lg bg-bgToggle w-full text-primaryText max-sm:gap-4">
            <button
            ...
            <button
              className="h-14 py-2 uppercase rounded-lg bg-bgSecondary shadow-[0_4px_0_rgba(0,0,0,0.5)] shadow-secondaryShadow text-mainText hover:bg-bgSecondaryHover text-2xl active:translate-y-1"
              onClick={deleteNum}
            >
              del
            </button>
            ...
            <button
              className={`h-14 py-2 rounded-lg col-span-2 uppercase bg-bgSecondary shadow-[0_4px_0_rgba(0,0,0,0.5)] shadow-secondaryShadow text-mainText hover:bg-bgSecondaryHover text-2xl active:translate-y-1`}
              onClick={clear}
            >
              reset
            </button>
            <button
              className={`h-14 py-2 rounded-lg col-span-2 bg-bgTertiary hover:bg-bgTertiaryHover lg shadow-[0_4px_0_rgba(0,0,0,0.5)] shadow-tertiaryShadow text-mainText active:translate-y-1`}
              onClick={result}
            >
              =
            </button>
